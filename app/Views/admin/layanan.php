        ...
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h2 class="d-flex align-items-center text-dark font-weight-bold mr-5">Layanan</h2>
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="" class="text-muted">Daftar Layanan</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->																			
                </div>
            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap">
                    <div class="card-title">
                        ...
                        <h3 class="card-label">Daftar Layanan</h3>
                    </div>
                            ...
                            <tr>
                                ...
                                <td nowrap="nowrap">
                                    <span data-toggle="tooltip" title="Edit" data-placement="bottom">
                                        <button type="button" class="btn btn-sm btn-default btn-icon mr-2" data-toggle="modal" data-target="#modalEdit<?= $row['id_layanan']; ?>">
                                    ...
                                    <span data-toggle="tooltip" title="Hapus" data-placement="bottom">
                                        <!-- <form action="/layanan/<?= $row['id_layanan']; ?>" method="post" class="d-inline">
                                            <?php csrf_field(); ?>
                                            <input type="hidden" name="_method" value="DELETE">  
                                            <button class="btn btn-sm btn-default btn-icon mr-2" type="submit" id="button-hapus">
                                                <span class="svg-icon svg-icon-md">
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                            <rect x="0" y="0" width="24" height="24"/>
                                        ...
                                        <a type="button" class="btn btn-sm btn-default btn-icon mr-2 button-hapus" href="/layanan/delete/<?= $row['id_layanan']; ?>">
                                            <span class="svg-icon svg-icon-md">
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                        <rect x="0" y="0" width="24" height="24"/>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/layanan/create" method="post" id="form">
                <?= csrf_field(); ?>
                    <div class="card-body py-0">
                        <div class="form-group">
                            <label>Nama Layanan <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" placeholder="Nama Layanan" id="layanan" name="layanan" autofocus/>
                        </div>
                        <!-- <div class="form-group">
...
<!--begin::Modal Edit-->
<?php foreach ($layanan as $row): ?>
<div class="modal fade" id="modalEdit<?= $row['id_layanan']; ?>" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form action="/layanan/update/<?= $row['id_layanan']; ?>" method="post" id="form">
                    <?= csrf_field(); ?>                                                         
                    <div class="card-body py-0">
                        <div class="form-group">
                            <label>Kode</label>
                            <input type="text" class="form-control" id="id" name="id" value="<?= $row['id_layanan']; ?>" disabled/>
                        </div>
                        <div class="form-group">
                            <label>Nama Layanan <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="layanan" name="layanan" value="<?= $row['layanan']; ?>"/>
                        </div>
                        <!-- <div class="form-group">
                            <label>Periode</label>
                            <div class="row">
