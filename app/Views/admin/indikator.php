    ...
    <div class="d-flex flex-column-fluid">
        <div class="container">
            ...
            <div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
                ...
                <div class="alert-text">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quo harum deleniti nesciunt enim quam facere ad natus tempore blanditiis cupiditate, numquam eum explicabo incidunt praesentium sit voluptatem, itaque beatae rerum!</div>
            </div>
            <!--end::Info--> 
                            ...
                            <tr>
                                ...
                                <td nowrap="nowrap">
                                    <span data-toggle="tooltip" title="Edit" data-placement="bottom">
                                        <button type="button" class="btn btn-sm btn-default btn-icon mr-2" data-toggle="modal" data-target="#modalEdit<?= $row['id_indikator']; ?>">
                                    ...
                                    <span data-toggle="tooltip" title="Hapus" data-placement="bottom">
                                        <a type="button" class="btn btn-sm btn-default btn-icon mr-2 button-hapus" href="/indikator/delete/<?= $row['id_indikator']; ?>">
                                            <span class="svg-icon svg-icon-md">
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                        <rect x="0" y="0" width="24" height="24"/>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/indikator/create" method="post" id="form-indikator">
                <?= csrf_field(); ?>
                    <div class="card-body py-0">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Indikator Unsur" id="indikator" name="indikator" />
                        </div>
                    </div>
            </div>
...
<!--begin::Modal Edit-->
<?php foreach ($indikator as $row): ?>
<div class="modal fade" id="modalEdit<?= $row['id_indikator']; ?>" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form action="/indikator/update/<?= $row['id_indikator']; ?>" method="post">
                    <?= csrf_field(); ?>                                                         
                    <div class="card-body py-0">
                        <div class="form-group">
                            <label>Unsur Survei <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            <label>Kode <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" placeholder="Kode" id="kode" name="kode" value="<?= $row['id_indikator']; ?>" />
                        </div>
                        <div class="form-group">
                            <label>Indikator <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" placeholder="Indikator Unsur" id="indikator" name="indikator" value="<?= $row['indikator']; ?>"/>
                        </div>
                    </div>
            </div>
